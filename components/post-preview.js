    ...
    <div className={`${className}`}>
      <Link as={`/posts/${slug}`} href="/posts/[slug]">
        <a className="inline-block max-w-2xl mx-auto mb-3 md:py-10 md:flex">
          <div className={cn("mb-4 md:mb-0 flex-shrink-0",{"w-screen md:w-56 md:mx-4": coverImage})}>
            <CoverImage className="object-cover" priority={priority} title={title} coverImage={coverImage} slug={slug} />
          </div>
